  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-footer">
        ...
        <div className="sidebar-footer-stat mono"><span className="muted">v0.3.0-alpha</span></div>
      </div>
      <style>{`
        ...
        .sidebar-section-label { font-family: var(--font-mono); font-size: 0.6em; text-transform: uppercase; letter-spacing: 0.15em; color: var(--text-muted); padding: 4px 16px 8px; margin-top: 8px; }
        .sidebar-nav { display: flex; flex-direction: column; gap: 1px; }
        .sidebar-item { display: flex; align-items: center; gap: 10px; padding: 10px 16px; background: transparent; border: none; border-left: 2px solid transparent; color: var(--text-secondary); cursor: pointer; text-align: left; font-family: var(--font-display); font-size: 0.85em; font-weight: 400; letter-spacing: 0.08em; text-transform: uppercase; transition: all 0.12s ease; }
        ...
        .sidebar-icon { font-size: 0.9em; width: 16px; text-align: center; }
        .sidebar-footer { margin-top: auto; border-top: 1px solid var(--border); padding-top: 8px; }
        .sidebar-footer-stat { padding: 4px 16px; font-size: 0.7em; }
      `}</style>
    </aside>
  );
}
